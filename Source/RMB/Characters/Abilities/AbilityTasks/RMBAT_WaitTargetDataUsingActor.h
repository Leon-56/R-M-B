...
#include "RMBAT_WaitTargetDataUsingActor.generated.h"
...
UCLASS()
class URMBAT_WaitTargetDataUsingActor : public UAbilityTask
{
	GENERATED_BODY()

	URMBAT_WaitTargetDataUsingActor(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static URMBAT_WaitTargetDataUsingActor* WaitTargetDataWithReusableActor(
